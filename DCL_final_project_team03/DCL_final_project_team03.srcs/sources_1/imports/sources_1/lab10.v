...
always @(*) begin
  if (~video_on)
    ...
    if (drop_region)
      rgb_next = 12'hf00;
    else if (water_region2 && data_water_out2 != 12'h0f0 && (~water_sold_out))
        rgb_next = data_water_out2;     
    else if (juice_region2 && data_juice_out2 != 12'h0f0 && (~juice_sold_out))
        rgb_next = data_juice_out2;
    else if (tea_region2 && data_tea_out2 != 12'h0f0 && (~tea_sold_out))
        rgb_next = data_tea_out2;
    else if (coke_region2 && data_coke_out2 != 12'h0f0 && (~coke_sold_out))
